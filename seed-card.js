...
const BUILD_NUMBER = 'v2026.08.03.36';
  ...
  renderCard() {
    ...
    const styles = `
      <style>
        ...
        .seed-card-body { padding: 0 calc(var(--seed-pad) * 0.5) calc(var(--seed-pad) * 0.5) calc(var(--seed-pad) * 0.5); }
        .seed-section {
    ...
    if (this._config.title) {
      titleHtml = `
        <div class="seed-title">
          <ha-icon icon="${this._config.title_icon || 'mdi:surround-sound'}"></ha-icon>
          <span class="seed-title-text">${this._config.title}</span>
      ...
      html += `
        <details class="seed-card-wrapper" open>
          <summary class="seed-card-summary">
            ${titleHtml || '<div class="seed-title"><ha-icon icon="mdi:surround-sound"></ha-icon><span class="seed-title-text">SEED</span></div>'}
...
class SEEDCardEditor extends HTMLElement {
  ...
  renderEditor() {
    ...
    const styles = `
      <style>
        .seed-ed { display: flex; flex-direction: column; gap: 16px; padding: 8px 0; }
        .seed-ed-row {
          display: flex;
          flex-direction: column;
          gap: 10px;
    ...
    // Version info at top
    html += `
      <div class="seed-ed-version">SEED Card Editor — ${BUILD_NUMBER}</div>
    `;
    ...
    html += `
      <details class="seed-ed-row">
        ...
        <span class="seed-ed-hint">Main card title bar</span>
        <input type="text" id="ed-title" value="${this._config.title || ''}" placeholder="e.g. SEED" />
        <div class="seed-ed-slider-row" style="margin-top:8px;">
    ...
    html += `
      ...
      <details class="seed-ed-row">
        <summary>Global Section Glow Settings</summary>
        <div class="seed-ed-collapsible-body">
        <div class="seed-ed-checkbox-row">
    ...
    html += `
      <details class="seed-ed-row">
        <summary>Global Section Borders</summary>
        <div class="seed-ed-collapsible-body">
      ...
      <details class="seed-ed-row">
        <summary>Global Section Background &amp; Shadow</summary>
        <div class="seed-ed-collapsible-body">
      ...
      <details class="seed-ed-row">
        <summary>Global Section Dividers</summary>
        <div class="seed-ed-collapsible-body">
      ...
      <details class="seed-ed-row">
        <summary>Global Child Row Visuals</summary>
        <div class="seed-ed-collapsible-body">
      ...
      <details class="seed-ed-row">
        <summary>Remove Text From Entity Names</summary>
        <div class="seed-ed-collapsible-body">
      ...
      <details class="seed-ed-row">
        <summary>Title Wrapper</summary>
        <div class="seed-ed-collapsible-body">
        <span class="seed-ed-hint">Collapse entire card down to just the Title bar. Border and glow here are independent of the per-section settings above.</span>
        <div class="seed-ed-checkbox-row">
    ...
    html += `
      <details class="seed-ed-row">
        <summary>YAML Config Preview</summary>
        <div class="seed-ed-collapsible-body">
